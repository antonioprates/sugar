...
/******************************************************************/
#elif defined test_func_1 || defined test_func_2 || defined test_func_3 || \
    defined test_func_4 || defined test_func_5 || defined test_func_6
...
static struct var_len {
  int i;
  const char str[];
} var_array[] = {{1, "abcdefghijklmnopqrstuvwxyz"},
