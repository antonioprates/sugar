...
#define MANTD(fp) \
  (((((fp.l.upper) & 0xFFFFF) | HIDDEND) << 10) | (fp.l.lower >> 22))
...
/* XXX: use gcc/sugar intrinsic ? */
#if defined __i386__
#define sub_ddmmss(sh, sl, ah, al, bh, bl)                              \
  __asm__("subl %5,%1\n\tsbbl %3,%0"                                    \
          : "=r"((USItype)(sh)), "=&r"((USItype)(sl))                   \
          : "0"((USItype)(ah)), "g"((USItype)(bh)), "1"((USItype)(al)), \
            "g"((USItype)(bl)))
...
/* XXX: fix sugar's code generator to do this instead */
