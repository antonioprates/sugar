...
#else
_CRTIMP FILE* __cdecl _fsopen(const char* _Filename,
                              const char* _Mode,
                              int _ShFlag);
#endif
...
size_t __cdecl fread(void* _DstBuf,
                     size_t _ElementSize,
                     size_t _Count,
                     FILE* _File);
...
size_t __cdecl fwrite(const void* _Str,
                      size_t _Size,
                      size_t _Count,
                      FILE* _File);
...
_CRTIMP int __cdecl _snscanf(const char* _Src,
                             size_t _MaxCount,
                             const char* _Format,
                             ...);
...
#undef vsnprintf
#undef snprintf
extern __attribute__((format(gnu_printf, 3, 0))) __attribute__((nonnull(3))) int
__mingw_vsnprintf(char* _DstBuf,
                  size_t _MaxCount,
                  const char* _Format,
                  va_list _ArgList);
extern __attribute__((format(gnu_printf, 3, 4))) __attribute__((nonnull(3))) int
__mingw_snprintf(char* s, size_t n, const char* format, ...);
int __cdecl vsnprintf(char* _DstBuf,
                      size_t _MaxCount,
                      const char* _Format,
                      va_list _ArgList);
...
__CRT_INLINE int __cdecl vsnprintf(char* s,
                                   size_t n,
                                   const char* format,
                                   va_list arg) {
...
#define _fputc_nolock(_c, _stream)                                   \
  (--(_stream)->_cnt >= 0 ? 0xff & (*(_stream)->_ptr++ = (char)(_c)) \
                          : _flsbuf((_c), (_stream)))
...
_CRTIMP size_t __cdecl _fread_nolock(void* _DstBuf,
                                     size_t _ElementSize,
                                     size_t _Count,
                                     FILE* _File);
...
_CRTIMP size_t __cdecl _fwrite_nolock(const void* _DstBuf,
                                      size_t _Size,
                                      size_t _Count,
                                      FILE* _File);
