...
#define PROBE_ALIGNMENT(_s)                                        \
  (TYPE_ALIGNMENT(_s) > TYPE_ALIGNMENT(DWORD) ? TYPE_ALIGNMENT(_s) \
                                              : TYPE_ALIGNMENT(DWORD))
#else
...
__CRT_INLINE BOOLEAN _interlockedbittestandreset64(LONG64* Base,
                                                   LONG64 Offset) {
  int old = 0;
...
__CRT_INLINE BOOLEAN _BitScanForward64(DWORD* Index, DWORD64 Mask) {
  __asm__ __volatile__("bsfq %1,%0"
                       : "=r"(Mask), "=m"((*(volatile long long*)Index)));
  return Mask != 0;
}
...
#define InterlockedExchangeAddSizeT(a, b) \
  InterlockedExchangeAdd64((LONG64*)a, b)
...
__CRT_INLINE SHORT InterlockedIncrement16(SHORT volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; addw $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
...
__CRT_INLINE SHORT InterlockedDecrement16(SHORT volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; subw $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
  return (c != 0 ? 0 : (s != 0 ? -1 : 1));
}
__CRT_INLINE SHORT InterlockedCompareExchange16(SHORT volatile* Destination,
                                                SHORT ExChange,
                                                SHORT Comperand) {
  SHORT prev;
...
//		$$$$
__CRT_INLINE LONG64 InterlockedAnd64(LONG64 volatile* Destination,
                                     LONG64 Value) {
...
__CRT_INLINE LONG64 InterlockedOr64(LONG64 volatile* Destination,
                                    LONG64 Value) {
...
__CRT_INLINE LONG64 InterlockedXor64(LONG64 volatile* Destination,
                                     LONG64 Value) {
...
__CRT_INLINE LONG InterlockedIncrement(LONG volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; addl $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
  return (c != 0 ? 0 : (s != 0 ? -1 : 1));
...
__CRT_INLINE LONG InterlockedDecrement(LONG volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; subl $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
  return (c != 0 ? 0 : (s != 0 ? -1 : 1));
...
#endif
__CRT_INLINE LONG InterlockedCompareExchange(LONG volatile* Destination,
                                             LONG ExChange,
                                             LONG Comperand) {
  LONG prev;
...
__CRT_INLINE LONG64 InterlockedIncrement64(LONG64 volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; addq $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
  return (c != 0 ? 0 : (s != 0 ? -1 : 1));
...
__CRT_INLINE LONG64 InterlockedDecrement64(LONG64 volatile* Addend) {
  unsigned char c;
  unsigned char s;
  __asm__ __volatile__("lock ; subq $1,%0; sete %1 ; sets %2"
                       : "=m"(*Addend), "=qm"(c), "=qm"(s)
                       : "m"(*Addend)
                       : "memory");
  return (c != 0 ? 0 : (s != 0 ? -1 : 1));
}
__CRT_INLINE LONG64 InterlockedExchange64(LONG64 volatile* Target,
                                          LONG64 Value) {
...
__CRT_INLINE LONG64 InterlockedCompareExchange64(LONG64 volatile* Destination,
                                                 LONG64 ExChange,
                                                 LONG64 Comperand) {
  LONG64 prev;
...
__CRT_INLINE PVOID
InterlockedCompareExchangePointer(PVOID volatile* Destination,
                                  PVOID ExChange,
                                  PVOID Comperand) {
  PVOID prev;
  __asm__ __volatile__("lock ; cmpxchgq %1,%2"
...
__CRT_INLINE PVOID InterlockedExchangePointer(PVOID volatile* Target,
                                              PVOID Value) {
  __asm__ __volatile("lock ; xchgq %0,%1"
                     : "=r"(Value)
                     : "m"(*Target), "0"(Value)
...
DWORD64 UnsignedMultiply128(DWORD64 Multiplier,
                            DWORD64 Multiplicand,
                            DWORD64* HighProduct);

__CRT_INLINE LONG64 MultiplyExtract128(LONG64 Multiplier,
                                       LONG64 Multiplicand,
                                       BYTE Shift) {
  ...
  extractedProduct =
      (LONG64)ShiftRight128((LONG64)lowProduct, (LONG64)highProduct, Shift);
  return extractedProduct;
}

__CRT_INLINE DWORD64 UnsignedMultiplyExtract128(DWORD64 Multiplier,
                                                DWORD64 Multiplicand,
                                                BYTE Shift) {
...
typedef PRUNTIME_FUNCTION (*PGET_RUNTIME_FUNCTION_CALLBACK)(DWORD64 ControlPc,
                                                            PVOID Context);
typedef DWORD (*POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK)(
    HANDLE Process,
    PVOID TableAddress,
    PDWORD Entries,
...
NTSYSAPI BOOLEAN __cdecl RtlAddFunctionTable(PRUNTIME_FUNCTION FunctionTable,
                                             DWORD EntryCount,
                                             DWORD64 BaseAddress);
...
__CRT_INLINE PVOID GetCurrentFiber(void) {
  void* ret;
  __asm__ volatile("movl	%%fs:0x10,%0" : "=r"(ret));
  return ret;
}
...
#define CONTEXT_FULL                                            \
  (CONTEXT_CONTROL | CONTEXT_FLOATING_POINT | CONTEXT_INTEGER | \
   CONTEXT_IA32_CONTROL)
#define CONTEXT_ALL                                             \
  (CONTEXT_CONTROL | CONTEXT_FLOATING_POINT | CONTEXT_INTEGER | \
   CONTEXT_DEBUG | CONTEXT_IA32_CONTROL)
...
BOOLEAN RtlAddFunctionTable(PRUNTIME_FUNCTION FunctionTable,
                            DWORD EntryCount,
                            ULONGLONG BaseAddress,
                            ULONGLONG TargetGp);
BOOLEAN RtlInstallFunctionTableCallback(DWORD64 TableIdentifier,
                                        DWORD64 BaseAddress,
                                        DWORD Length,
                                        DWORD64 TargetGp,
                                        PGET_RUNTIME_FUNCTION_CALLBACK Callback,
...
VOID RtlRestoreContext(PCONTEXT ContextRecord,
                       struct _EXCEPTION_RECORD* ExceptionRecord);
VOID __jump_unwind(ULONGLONG TargetMsFrame,
...
#define VALID_IMPERSONATION_LEVEL(L)            \
  (((L) >= SECURITY_MIN_IMPERSONATION_LEVEL) && \
...
#define VALID_AUDIT_POLICY_BITS                                \
  (TOKEN_AUDIT_SUCCESS_INCLUDE | TOKEN_AUDIT_SUCCESS_EXCLUDE | \
   TOKEN_AUDIT_FAILURE_INCLUDE | TOKEN_AUDIT_FAILURE_EXCLUDE)
#define VALID_TOKEN_AUDIT_POLICY_ELEMENT(P)              \
...
#define PER_USER_AUDITING_POLICY_SIZE(p)                                     \
  (sizeof(TOKEN_AUDIT_POLICY) + (((p)->PolicyCount > ANYSIZE_ARRAY)          \
                                     ? (sizeof(TOKEN_AUDIT_POLICY_ELEMENT) * \
                                        ((p)->PolicyCount - ANYSIZE_ARRAY))  \
                                     : 0))
#define PER_USER_AUDITING_POLICY_SIZE_BY_COUNT(C)                    \
  (sizeof(TOKEN_AUDIT_POLICY) +                                      \
   (((C) > ANYSIZE_ARRAY)                                            \
        ? (sizeof(TOKEN_AUDIT_POLICY_ELEMENT) * ((C)-ANYSIZE_ARRAY)) \
        : 0))
...
#define TIMER_ALL_ACCESS                                        \
  (STANDARD_RIGHTS_REQUIRED | SYNCHRONIZE | TIMER_QUERY_STATE | \
   TIMER_MODIFY_STATE)
...
RtlLookupFunctionEntry(DWORD64 ControlPc,
                       PDWORD64 ImageBase,
                       PUNWIND_HISTORY_TABLE HistoryTable);
NTSYSAPI VOID NTAPI RtlUnwindEx(PVOID TargetFrame,
                                PVOID TargetIp,
                                PEXCEPTION_RECORD ExceptionRecord,
                                PVOID ReturnValue,
                                PCONTEXT ContextRecord,
...
__CRT_INLINE PVOID __cdecl memcpy_inline(void* dst,
                                         const void* src,
                                         size_t size) {
...
NTSYSAPI ULONGLONG NTAPI VerSetConditionMask(ULONGLONG ConditionMask,
                                             DWORD TypeMask,
                                             BYTE Condition);
...
typedef VOID(NTAPI* RTL_VERIFIER_DLL_LOAD_CALLBACK)(PWSTR DllName,
                                                    ...
                                                    SIZE_T DllSize,
                                                    PVOID Reserved);
typedef VOID(NTAPI* RTL_VERIFIER_DLL_UNLOAD_CALLBACK)(PWSTR DllName,
                                                      PVOID DllBase,
                                                      SIZE_T DllSize,
                                                      PVOID Reserved);
typedef VOID(NTAPI* RTL_VERIFIER_NTDLLHEAPFREE_CALLBACK)(PVOID AllocationBase,
...
#define VERIFIER_STOP(Code, Msg, P1, S1, P2, S2, P3, S3, P4, S4)             \
  {                                                                          \
    RtlApplicationVerifierStop((Code), (Msg), (ULONG_PTR)(P1), (S1),         \
                               (ULONG_PTR)(P2), (S2), (ULONG_PTR)(P3), (S3), \
                               (ULONG_PTR)(P4), (S4));                       \
  }

VOID NTAPI RtlApplicationVerifierStop(ULONG_PTR Code,
                                      PSTR Message,
                                      ULONG_PTR Param1,
                                      PSTR Description1,
                                      ULONG_PTR Param2,
...
DWORD NTAPI RtlMultipleAllocateHeap(PVOID HeapHandle,
                                    DWORD Flags,
                                    SIZE_T Size,
                                    DWORD Count,
                                    PVOID* Array);
DWORD NTAPI RtlMultipleFreeHeap(PVOID HeapHandle,
                                DWORD Flags,
                                DWORD Count,
                                PVOID* Array);
...
#define SERVICE_TYPE_ALL                              \
  (SERVICE_WIN32 | SERVICE_ADAPTER | SERVICE_DRIVER | \
...
__CRT_INLINE struct _TEB* NtCurrentTeb(void) {
  struct _TEB* ret;
  __asm__ volatile("movl	%%fs:0x18,%0" : "=r"(ret));
  return ret;
}
#endif
