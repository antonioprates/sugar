...
#define EVENT_E_CANT_MODIFY_OR_DELETE_UNCONFIGURED_OBJECT \
  _HRESULT_TYPEDEF_(0x8004020DL)
#define EVENT_E_CANT_MODIFY_OR_DELETE_CONFIGURED_OBJECT \
  _HRESULT_TYPEDEF_(0x8004020EL)
...
#define HRESULT_FROM_SETUPAPI(x)                                   \
  ((((x) & (APPLICATION_ERROR_MASK | ERROR_SEVERITY_ERROR)) ==     \
    (APPLICATION_ERROR_MASK | ERROR_SEVERITY_ERROR))               \
       ? ((HRESULT)(((x)&0x0000FFFF) | (FACILITY_SETUPAPI << 16) | \
                    0x80000000))                                   \
...
#define SPAPI_E_AUTHENTICODE_TRUST_NOT_ESTABLISHED \
  _HRESULT_TYPEDEF_(0x800F0242L)
#define SPAPI_E_AUTHENTICODE_PUBLISHER_NOT_TRUSTED \
  _HRESULT_TYPEDEF_(0x800F0243L)
