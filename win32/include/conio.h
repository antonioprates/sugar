...
_CRTIMP int __cdecl _vcprintf_l(const char* _Format,
                                _locale_t _Locale,
                                va_list _ArgList);
_CRTIMP int __cdecl _cprintf_p_l(const char* _Format, _locale_t _Locale, ...);
_CRTIMP int __cdecl _vcprintf_p_l(const char* _Format,
                                  _locale_t _Locale,
                                  va_list _ArgList);
...
__CRT_INLINE void __inbytestring(unsigned short Port,
...
__CRT_INLINE void __inwordstring(unsigned short Port,
...
__CRT_INLINE void __indwordstring(unsigned short Port,
...
__CRT_INLINE void __outbytestring(unsigned short Port,
                                  unsigned char* Buffer,
                                  unsigned long Count) {
...
__CRT_INLINE void __outwordstring(unsigned short Port,
                                  unsigned short* Buffer,
                                  unsigned long Count) {
...
__CRT_INLINE void __outdwordstring(unsigned short Port,
                                   unsigned long* Buffer,
                                   unsigned long Count) {
...
/* Register sizes are different between 32/64 bit mode. So we have to do this
   for _WIN64 and _WIN32 separately.  */
...
__CRT_INLINE void __writecr2(unsigned __int64 Data) {
  __asm__ __volatile__("mov %[Data], %%cr2" : : [ Data ] "q"(Data) : "memory");
}
