...
int __cdecl __CppXcptFilter(unsigned long _ExceptionNum,
                            struct _EXCEPTION_POINTERS* _ExceptionPtr);
int __cdecl _XcptFilter(unsigned long _ExceptionNum,
                        struct _EXCEPTION_POINTERS* _ExceptionPtr);
...
#define __except1                                                            \
  __asm__("movq (%%rsp),%%rax;movq %%rax,%%gs:0;addq $16,%%rsp;" : : : "%ra" \
                                                                       "x");
#else
#define __try1(pHandler)
#define __except1
